...
function Clock() {
    ...
    const getTwoDigitsString = (num: number): string => num < 10 ? '0' + num : num.toString()
    ...
    const stringDate =  `${getTwoDigitsString(date.getDate())}.${getTwoDigitsString(date.getMonth() + 1)}.${date.getFullYear()}` || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
